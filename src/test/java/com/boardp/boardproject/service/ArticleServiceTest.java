...
class ArticleServiceTest {
    ...
    @DisplayName("검색어 없이 게시글을 해시태그 검색하면, 빈페이지를 반혼한다")
    @Test
    void givenNoSearchParameters_whenSearchingArticlesViaHashtah_thenReturnsEmptyPage() {
        // Given
        Pageable pageable = Pageable.ofSize(20);
    ...
    @DisplayName("게시글을 해시태그 검색하면, 게시글 페이지를 반혼한다")
    @Test
    void givenHashtag_whenSearchingArticlesViaHashtah_thenReturnsArticlesPage() {
        // Given
        String hashtag = "#java";
        Pageable pageable = Pageable.ofSize(20);
